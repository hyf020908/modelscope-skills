...
<div class="links">
[arXiv]({{ARXIV_URL}}) | [PDF]({{PDF_URL}}) | [Code]({{CODE_URL}}) | [Demo]({{DEMO_URL}})
</div>
...
- **Code**: [Repository]({{CODE_URL}})
- **Models**: [ModelScope Models]({{MODEL_URL}})
- **Datasets**: [ModelScope Datasets]({{DATASET_URL}})
- **Demo**: [Interactive Demo]({{DEMO_URL}})
